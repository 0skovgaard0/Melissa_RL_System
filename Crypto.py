...
#         normalized_data.to_csv("normalized_merged_crypto_data.csv", index_label='date')
...
#         cleaned_data = crypto_data.clean_data(data, ticker)
#         cleaned_data_list.append(cleaned_data)

#     # Merge and fill data
#     merged_data = crypto_data.merge_and_fill_data(cleaned_data_list)
...
class CryptoData:
    ...
    def merge_and_fill_data(self, data_list):
        ...
        long_format_data.to_csv("normalized_crypto_2_0.csv", index=False)
